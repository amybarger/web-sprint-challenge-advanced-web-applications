...
It is used as an authentication into the back end api.

2. What steps can you take in your web apps to keep your data secure?

Creating private routes and using axiosWithAuth.

3. Describe how web servers work.

The user/client communicates with the server with network requests using HTTP.
